...
const sections = [
  ...
  },
  {
    to: '/image-match-game',
    number: '07',
    title: 'Ойын — Сурет-атау',
    description: 'Намаз қимылдарының суреттерін атауларымен сәйкестендір',
    icon: '🖼️',
    ...
    <main translate="no" className="max-w-5xl mx-auto px-4 py-8">
      ...
      <section className="text-center py-8 mb-8">
        <div className="inline-flex items-center gap-2 bg-emerald-50 border border-emerald-200 rounded-full px-4 py-1.5 mb-4">
          ...
          <span className="text-emerald-700 text-sm font-medium">Бес парыздың 2-ші тірегі</span>
        </div>
        <h1 className="text-3xl md:text-4xl font-bold text-primary-900 mb-3">Намаз үйрену</h1>
        <div className="mt-5 max-w-2xl mx-auto bg-white border border-primary-100 rounded-2xl px-6 py-4 text-left shadow-sm">
          ...
          <p className="text-gray-700 text-sm leading-relaxed">
            Сіздерге намаздың маңызын түсіндіру, намаз қимылдары мен дұғаларын үйрету, практикалық түрде оқып
            көрсету және намазды күнделікті өмірдің ажырамас бөлігіне айналдыруға мотивация беру.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {sections.map((sec) => (
            ...
            >
              ...
              <div>
                <span className="text-xs font-semibold text-gray-400 uppercase tracking-wider">{sec.number}</span>
