...
const scenariosKk: Scenario[] = [
  ...
  },
  {
    ...
    situation:
      'Намаз оқып болдың. Бір досың: «Сен қаншалықты намаз оқисың?» деп сұрады. Ішіңде «айтсам, мені жақсы деп ойлайды» деген ой туды.',
    choices: [
      { label: 'A', text: '«Иә, мен намаз оқимын» деп мақтану' },
      { label: 'B', text: 'Скромно жауап беру — «Аллаhтың рақымымен» деп айту' },
      { label: 'C', text: 'Намаз санын мақтана отырып айту' },
      { label: 'D', text: 'Намаз оқымағанға санатып кету' },
    ],
    correctIndex: 1,
    explanation:
      'Рия — ғибадатты адамдарға көрсету үшін жасау. Бұл ниетті бұзады. «Аллаhтың рақымымен» деп жауап беру — ықылас пен шүкірдің белгісі. Ең жақсы амал — ықыласпен жасалған амал.',
  },
]
